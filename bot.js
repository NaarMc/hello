...
client.on('message', message => {
    ...
    if(message.content.startsWith(prefix + 'قفل تكت')) {
            ...
            return;
                ...
                let embed = new Discord.RichEmbed()
                    ...
                    message.channel.sendEmbed(embed) .then(codes => {
                        ...
                        const filter = msg => msg.content.startsWith(prefix + 'قفل تكت');
                        message.channel.awaitMessages(response => response.content === prefix + 'قفل تكت', {
                            max: 1,
                            time: 20000,
                            errors: ['time']
                        })
...
client.on('message', message => {
 ...
 client.on('message', message => {
    if (message.content.startsWith("-قائمة البان")) {
